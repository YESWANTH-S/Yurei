...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const infoData = [
    ...
    {
      title: "Anime Original – Winter Stroll",
      desc: "Snow muffles the world as she moves forward — blue hair, drifting scarf, and quiet steps along a frost-kissed path beneath evergreen silhouettes.",
      tags: ["#WinterMood", "#AnimeGirl", "#SnowScene", "#SoftLighting"]
    },
    {
      title: "Cyberpunk",
